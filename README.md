# Build Apps with AI — Companion Repository

This is the companion repository for *Build Apps with AI: Hands-on guide to creating applications using AI coding assistants* by Omer Haderi.

If you're reading the book, this is where you come for:
